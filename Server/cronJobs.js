    ...
    try {
        ...
        rooms.forEach(async(room)=>{
            if(room.retail_price){
                ...
                console.log(`Updated selling price ${updatedSellingPrice} for room ID ${room.room_id}`);
            }
        })
        console.log("Selling prices updated for all rooms based on the day of week");
